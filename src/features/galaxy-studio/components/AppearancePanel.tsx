...
export function AppearancePanel({ planet, onChange, onReset }: AppearancePanelProps) {
        ...
        <div className="studio-panel">
            <div className="studio-panel__section">
                <div className="studio-panel__header-row">
                    <span className="studio-panel__title">Biome & Palette</span>
                ...
                <div className="studio-field">
                    <div className="studio-field__label-row">
                        <label htmlFor="planet-radius">Planet Radius</label>
                        <span className="studio-field__value">{planet.radius.toFixed(2)}</span>
                        <Tooltip text="Physical radius of the planet's terrain sphere." />
                    </div>
                    <input
                        id="planet-radius"
                        type="range"
                    ...
                    <>
                        <div className="studio-field">
                            ...
                            <input
                                id="ring-inner"
                                type="range"
                                min={planet.radius * 1.1}
                                max={planet.radius * 2.2}
                                step="0.05"
                        ...
                        <div className="studio-field">
                            ...
                            <input
                                id="ring-outer"
                                type="range"
                                min={ring.innerRadius + 0.1}
                                max={planet.radius * 3.5}
                                step="0.05"
